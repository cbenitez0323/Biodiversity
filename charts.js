...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    var bubbleLayout = {
        // add a title, a label for the x-axis, margins, and the hovermode property.
    ...
    var filteredMetadata = data.metadata.filter(element => element.id == sample);
    ...
    var gaugeData = [{
          domain: { x: [0, 1], y: [0, 1] },
          value: wfreq,
          title: { text: "Belly Button Washing Frequnecy" },
          type: "indicator",
